...
private WPI_TalonSRX shooterDriveBottom;
    ...
    private final static double SPEED_P_CONSTANT_TOP = 0.016; //0.0035
    private final static double SPEED_I_CONSTANT_TOP = 0.00016;//-5.0;
    private final static double SPEED_D_CONSTANT_TOP = 0.0;
    private final static double SPEED_F_CONSTANT_TOP = -0.00;

    private final static double SPEED_P_CONSTANT_BOTTOM = 0.016;//.005;//5.0;
    private final static double SPEED_I_CONSTANT_BOTTOM = 0.00016;//0.0025;
    ...
    shooterDriveBottom.setInverted(true);
    shooterDriveBottom.setSensorPhase(true);
