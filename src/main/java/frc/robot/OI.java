...
public JoystickButton[] alignToTargets = new JoystickButton[6];
public JoystickButton intakeControllerButton;
...
intakeControllerButton = new JoystickButton(copilotControl, 7);
intakeControllerButton.whileHeld(new Intaking(.6));
...
shiftHighButton = new JoystickButton(driverLeftJoystick, 4);
...
alignToTargets[0] = new JoystickButton(driverRightJoystick, 7);
alignToTargets[1] = new JoystickButton(driverRightJoystick, 8);
alignToTargets[2] = new JoystickButton(driverRightJoystick, 9);
alignToTargets[3] = new JoystickButton(driverRightJoystick, 10);
alignToTargets[4] = new JoystickButton(driverRightJoystick, 11);
alignToTargets[5] = new JoystickButton(driverRightJoystick, 12);
for(int i = 0; i < alignToTargets.length; i++) {
    alignToTargets[i].whenPressed(new AlignDrivetrainToTarget());
}
...
shiftLowButton.whenPressed(new ShiftLow());
        ...
        SmartDashboard.putData("DriveXFeet: DriveTrain_Drive_-5_feet", new DriveXFeet(-5, .3));
        ...
        SmartDashboard.putData("IntakeOut", new Intaking(-.30));
        SmartDashboard.putData("IntakeIn", new Intaking(.30));
        SmartDashboard.putData("IndexIn", new Index(.2));
        SmartDashboard.putData("ConveyDown", new Conveying(-.2));
        SmartDashboard.putData("ConveyUp", new Conveying(.2));
        SmartDashboard.putData("Testy Autony", new TestyAutony());
        SmartDashboard.putData("AutonavSlalomPath", new AutonavSlalomPath());
